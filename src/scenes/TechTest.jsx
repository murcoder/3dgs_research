...
const TechTest = forwardRef(
  ({ debug, cameraMode, toneMapping, alphaTest, show3DScan, paused }, ref) => {
          ...
          <group ref={laserRef} rotation={[0, Math.PI / 2, 0]}>
            ...
            <Html
              ...
              <Label
                ...
                content={'Created with LumaAI | exported in Luma | integrated with DREI <Splat>'}
              />
            </Html>
            ...
            <Html
              center
              position={[
                laserHuggingPosition.x,
                laserHuggingPosition.y + 3,
                laserHuggingPosition.z
              ]}
              distanceFactor={8}
              style={{ pointerEvents: 'none' }}>
              <Label
                title={'Huggingface'}
                content={
                  'Created with LumaAI | exported in Huggingface | integrated with DREI <Splat>'
                }
              />
            </Html>
